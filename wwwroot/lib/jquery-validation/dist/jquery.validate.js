...
$.extend( $.validator, {
	...
	messages: {
		...
		remote: "Arregle ese campo.",
		email: "Introduzca una dirección email válida.",
		url: "Introduzca una URL válida.",
		date: "Introduzca una fecha válida.",
		dateISO: "Introduzca una fecha válida (ISO).",
		number: "Debe introducir un número válido.",
		digits: "Introduzca solo dígitos.",
		equalTo: "Introduzca elmismo valor de nuevo.",
		maxlength: $.validator.format( "No introduzca más de {0} caracteres." ),
		minlength: $.validator.format( "Introdyzca al menos {0} caracteres." ),
		rangelength: $.validator.format( "El valor debe tener entre {0} y {1} caracteres." ),
